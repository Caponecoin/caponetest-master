...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 CPN"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 CPN"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 CPN"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 CPN"));
