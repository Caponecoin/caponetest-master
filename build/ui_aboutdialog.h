...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CaponeCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>CaponeCoin</b> version", 0));
...
"Copyright \302\251 2014 The CaponeCoin developers", 0));
